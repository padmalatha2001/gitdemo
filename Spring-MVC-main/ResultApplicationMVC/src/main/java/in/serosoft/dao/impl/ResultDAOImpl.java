...
public class ResultDAOImpl implements ResultDAO {
	...
	public ResultModel calculateResult(Long studentId) {
		...
		criteria.createAlias("stud.person","person");
		...
		Projection pro10=Projections.property("stud.admissionId");
		Projection pro11=Projections.property("stud.studentId");
		...
		if (studentId !=null)
			Restrictions.eq("stud.studentId", studentId);
